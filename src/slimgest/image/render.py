...
from slimgest.local.stages._io import iter_images, read_json
...
def _clamp_bbox_xyxy_px(
    bbox: Sequence[float], *, w: int, h: int
...
def _bbox_xyxy_norm_to_px(
    bbox_xyxy_norm: Sequence[float], *, w: int, h: int
) -> Tuple[int, int, int, int]:
