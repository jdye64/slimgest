...
def embed_index_collection(
    ...
    **kwargs,
        ...
        for results_file in data:
            ...
            with open(results_file, "r") as infile:
                ...
                embeddings = infer_microservice(
                    results, model_name=model_name, embedding_endpoint=embedding_endpoint, nvidia_api_key=nvidia_api_key, input_type=intput_type, truncate=truncate, batch_size=batch_size, grpc=grpc
                )
    ...
    # running all at once
        ...
        embeddings = infer_microservice(
            data, model_name=model_name, embedding_endpoint=embedding_endpoint, nvidia_api_key=nvidia_api_key, input_type=intput_type, truncate=truncate, batch_size=batch_size, grpc=grpc
        )
